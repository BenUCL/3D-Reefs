...
# Constants
COLMAP_FOLDER = "/home/bwilliams/encode/code/lichtfeld-studio/data/reef_test/sparse/0"
MAX_CAMERAS = 50
BUFFER_METERS = 0.0
TARGET_BINS = 100

# Print documentation to understand the interface
print("splat_patches documentation:")
print(splat_patches.__doc__)
print("\nBoundingBox documentation:")
print(BoundingBox.__doc__)
...
def create_interactive_plot(cameras: list[tuple[float, float]]) -> None:
    ...
    def update_plot(val=None):
        ...
        try:
            ...
            # Draw bounding boxes - now working with dictionaries
            for i, patch_dict in enumerate(patch_dicts):
                min_x = patch_dict['min_x']
                min_y = patch_dict['min_y']
                max_x = patch_dict['max_x']
                max_y = patch_dict['max_y']
                width = max_x - min_x
                height = max_y - min_y
            ...
            ax_main.set_title(f'Camera Partitioning: {len(patch_dicts)} patches '
